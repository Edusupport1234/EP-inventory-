      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#e6decf] pb-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-[#f05a3e] text-white rounded-lg text-[10.5px] font-extrabold uppercase tracking-wider hover:bg-[#d44327] transition-all hover:shadow shadow-sm active:scale-95 shrink-0"
          >
            ...
            >
              ...
              {isSavingItem ? (
                <div className="p-12 flex flex-col items-center justify-center space-y-4">
                  <div className="w-12 h-12 border-4 border-[#f05a3e] border-t-transparent rounded-full animate-spin"></div>
                ...
                <form onSubmit={handleCreateNewItem} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
                  ...
                  <div className="space-y-1.5 text-left">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded px-4 py-2.5 text-sm font-bold focus:bg-white focus:ring-1 focus:ring-[#f05a3e]/20 outline-none text-slate-800"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 text-left">
                    <div className="space-y-1.5">
                      ...
                      <input 
                        ...
                        placeholder="0" 
                        className="w-full bg-slate-50 border border-slate-200 rounded px-4 py-2 text-sm font-bold focus:bg-white focus:ring-1 focus:ring-[#f05a3e]/20 outline-none text-slate-800"
                      />
                    </div>
                    <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5 text-left">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded px-4 py-2.5 text-xs font-bold focus:bg-white focus:ring-1 focus:ring-[#f05a3e]/20 outline-none text-slate-800"
                    />
                  </div>
